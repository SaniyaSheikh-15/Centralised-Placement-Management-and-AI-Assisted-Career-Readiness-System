...
const personalInfo = {
  ...
  profilePhoto: null, // null triggers fallback avatar
...
const softSkills = ['Leadership', 'Teamwork', 'Communication', 'Problem Solving', 'Time Management'];
...
// ─── 6.6 Resume ───────────────────────────────────────────────────────────
const resume = {
  uploadedResume: null, // No file in mock — tests empty state
  fileName: '',
  fileSize: 0,
  uploadDate: '',
};
