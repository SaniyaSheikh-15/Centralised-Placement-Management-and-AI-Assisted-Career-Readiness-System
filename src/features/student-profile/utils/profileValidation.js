...
export function validatePAN(value) {
  if (!value) return { valid: true, message: '' }; // PAN is optional
...
export function validatePassingYear(value) {
...
export function validateURL(value, fieldName = 'URL') {
  if (!value) return { valid: true, message: '' }; // URLs are optional
  try {
...
// ─── Input Masks ──────────────────────────────────────────────────────────
export function maskNumericOnly(value) {
