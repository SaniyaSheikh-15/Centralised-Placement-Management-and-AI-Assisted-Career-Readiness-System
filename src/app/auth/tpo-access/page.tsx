...
import {
  FormErrorAlert,
  FormSuccessAlert,
} from "@/components/auth/FormAlert";
      ...
      <section className="w-full max-w-[620px] p-[35px_40px] max-[600px]:p-[28px_20px] rounded-[22px] max-[600px]:rounded-[18px] border border-[#1b304b] bg-gradient-to-br from-[rgba(15,28,46,0.97)] to-[rgba(8,18,32,0.97)] shadow-[0_25px_80px_rgba(0,0,0,0.35)] backdrop-blur-[20px]">
        ...
        <div className="text-center mb-[25px]">
          ...
          <p className="text-[#8fa2bb] text-[13px] leading-[1.6]">
            T&P Officer accounts require verification and approval from
        ...
        <div className="flex items-start gap-[12px] p-[15px] mb-[25px] rounded-[12px] bg-[rgba(118,87,255,0.08)] border border-[rgba(118,87,255,0.22)] text-left">
          ...
          <div>
            ...
            <p className="text-[#8fa2bb] text-[10px] leading-[1.5]">
              Your request will be reviewed by the authorized institution
        ...
        {/* General Error Alert */}
        {generalError && (
          <FormErrorAlert message={generalError} />
        )}
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="mb-[17px]">
            ...
            <select
              ...
              className="flex h-8 w-full items-center justify-between gap-1.5 rounded-lg border border-input bg-transparent px-2.5 py-2 text-sm whitespace-nowrap text-[#f4f7fb] transition-colors outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50"
            >
              <option
                value=""
                className="bg-[#0f1c2e] text-[#8fa2bb]"
              >
              ...
              <option
                ...
                className="bg-[#0f1c2e] text-[#f4f7fb]"
              >
                Training &amp; Placement Officer
              </option>

              <option
                value="Assistant T&P Officer"
                className="bg-[#0f1c2e] text-[#f4f7fb]"
              >
